...
class Post extends yupe\models\YModel implements ICommentable
{
    ...
    public function rules()
    {
        return [
            ...
            ['tags', 'default', 'value' => []],
            [
                'id, blog_id, create_user_id, update_user_id, create_time, update_time, slug, publish_time, title, quote, content, link, status, comment_status, access_type, meta_title, meta_keywords, meta_description, lang, cooking',
                'safe',
                'on' => 'search',
            ],
        ];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'cooking' => Yii::t('BlogModule.blog', 'Время приготовления'),
        ];
    }
    ...
    public function search($limit = null)
    {
        ...
        $criteria->compare('t.cooking', $this->cooking, true);
