...
class News extends yupe\models\YModel
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'short_text' => Yii::t('NewsModule.news', 'Дополнительое описание'),
            ...
            'cooking' => Yii::t('NewsModule.news', 'Время приготовления'),
            'visit' => Yii::t('NewsModule.news', 'Просмотры'),
            'video' => Yii::t('NewsModule.news', 'Ссылка для видео'),
        ];
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('t.cooking', $this->cooking);
