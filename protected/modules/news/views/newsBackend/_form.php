                ...
                <?= $form->textFieldGroup(
                    ...
                    [
                        'widgetOptions' => [
                            'htmlOptions' => [
                                'class' => 'popover-help',
                                'data-original-title' => $model->getAttributeLabel('cooking'),
                                'data-content' => $model->getAttributeDescription('cooking'),
                            ],
                        ],
                    ]
                ); ?>
                ...
                <?= $form->textFieldGroup(
                    ...
                    [
                        'widgetOptions' => [
                            'htmlOptions' => [
                                'class' => 'popover-help',
                                'data-original-title' => $model->getAttributeLabel('video'),
                                'data-content' => $model->getAttributeDescription('video'),
                            ],
                        ],
                    ]
                ); ?>
